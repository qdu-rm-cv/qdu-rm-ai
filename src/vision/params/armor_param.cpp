...
bool ArmorParam::Read(const std::string &params_path) {
  ...
  if (fs.isOpened()) {
    ...
    parami_.aspect_ratio_high_th = double(fs["aspect_ratio_high_th"]) * 100.;
...
void ArmorParam::Write(const std::string &params_path) {
  ...
  fs << "contour_area_low_th" << paramd_.contour_area_low_th / 100000.;
  fs << "contour_area_high_th" << paramd_.contour_area_high_th / 100000.;
  fs << "bar_area_low_th" << paramd_.bar_area_low_th / 100000.;
  fs << "bar_area_high_th" << paramd_.bar_area_high_th / 100000.;
  fs << "angle_high_th" << paramd_.angle_high_th / 10.;
  fs << "aspect_ratio_low_th" << paramd_.aspect_ratio_low_th / 10.;
  fs << "aspect_ratio_high_th" << paramd_.aspect_ratio_high_th / 10.;
  fs << "angle_diff_th" << paramd_.angle_diff_th / 1000.;
  fs << "length_diff_th" << paramd_.length_diff_th / 1000.;
  fs << "height_diff_th" << paramd_.height_diff_th / 1000.;
  fs << "area_diff_th" << paramd_.area_diff_th / 1000.;
  fs << "center_dist_low_th" << paramd_.center_dist_low_th / 1000.;
  fs << "center_dist_high_th" << paramd_.center_dist_high_th / 1000.;
